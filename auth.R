...
MeetupGetToken <- function(code,
                           client.id     = getOption("shiny_meetup_stats.client_id"),
                           client.secret = getOption("shiny_meetup_stats.client_secret"),
                           redirect.uri  = getOption("shiny_meetup_stats.redirect_uri")
                           ){
